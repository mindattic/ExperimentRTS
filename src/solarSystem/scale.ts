...
export const BODY_DEFS: readonly BodyDef[] = [
  { name: "Mercury", kind: "rocky", auDistance: 0.39, orbitYears: 0.24, eccentricity: 0.21, relativeRadius: 0.45, spinPeriodSeconds: 150, seed: 101, atmosphereLevel: 0 },
  { name: "Venus", kind: "rocky", auDistance: 0.72, orbitYears: 0.62, eccentricity: 0.01, relativeRadius: 0.9, spinPeriodSeconds: 260, seed: 102, atmosphereLevel: 0.15 },
  ...
  { name: "Mars", kind: "rocky", auDistance: 1.52, orbitYears: 1.88, eccentricity: 0.09, relativeRadius: 0.55, spinPeriodSeconds: 210, seed: 103, atmosphereLevel: 0.05 },
  { name: "Jupiter", kind: "gasGiant", auDistance: 5.2, orbitYears: 11.9, eccentricity: 0.05, relativeRadius: 4.0, spinPeriodSeconds: 90, seed: 104, atmosphereLevel: 0 },
  { name: "Saturn", kind: "gasGiant", auDistance: 9.5, orbitYears: 29.4, eccentricity: 0.06, relativeRadius: 3.5, spinPeriodSeconds: 95, seed: 105, atmosphereLevel: 0 },
  { name: "Uranus", kind: "gasGiant", auDistance: 19.2, orbitYears: 84.0, eccentricity: 0.05, relativeRadius: 2.6, spinPeriodSeconds: 130, seed: 106, atmosphereLevel: 0 },
  ...
  { name: "Pluto", kind: "dwarf", auDistance: 39.5, orbitYears: 248.0, eccentricity: 0.25, relativeRadius: 0.3, spinPeriodSeconds: 300, seed: 108, atmosphereLevel: 0 },
  { name: "Eris", kind: "dwarf", auDistance: 68.0, orbitYears: 559.0, eccentricity: 0.44, relativeRadius: 0.28, spinPeriodSeconds: 320, seed: 109, atmosphereLevel: 0 },
];
